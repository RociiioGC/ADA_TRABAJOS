// Ejercicio 10 - Cálculo de Descuento: Escribe un programa que calcule el precio final de un producto después de aplicar un descuento. 
...
console.log("El precio final es: " + precioFinal); // tambien se puede usar ${precioFinal.toFixed(2)} 
