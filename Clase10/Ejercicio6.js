...
// Declara dos variables con valores numéricos. Utiliza operadores de comparación y lógicos para verificar si ambos números son mayores que 
...
let resultado = primerNumero > 10 && segundoNumero > 10;

console.log(resultado); //Mostrar Resultado en la Consola: 
...
// Pista 2: Los operadores de comparación en JavaScript son >, <, >=, <=, ===, !==. El operador lógico "&&" (y lógico) se utiliza para combinar 
// condiciones y todas deben cumplirse para que el resultado sea verdadero. 